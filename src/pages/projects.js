          ...
          <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0 ">
            <div className="col-span-12">
              <FeaturedProject
                ...
                img={horizonTech}
                summary="HorizonTech offers cutting-edge technology services, including app and web development, SEO, graphics and UI/UX design, and digital marketing. They empower businesses to expand their digital presence, enhance efficiency, and achieve growth through innovative and tailored solutions. HorizonTech aims to be a partner in navigating the digital age and fostering success.   
 "
                link="https://horizon-tech-olive.vercel.app/"
