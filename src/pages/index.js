        ...
        <Layout className='pt-0 md:p-16 sm:pt-2'>
          <div className='flex items-center justify-between w-full lg:flex-col'>
            <div className='w-1/2 lg:w-full md:w-full'>
              ...
              mt-24 md:w-[20rem] md:h-[341px] md:mt-16 md:ml-[72px] sm:ml-20 xs:ml-10 lg:ml-[160px] sm:mt-32 mb-4 dark:border-light'
              >
                <Image
                  src={profilePic}
                  alt='profilePic'
                  ...
                  className='-mt-32 lg:inline-block md:inline-block md:w-[24rem] sm:w-[20rem] '
                />
              </div>
            </div>
