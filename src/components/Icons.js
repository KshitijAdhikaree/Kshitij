...
export const CoffeeIcon = (className, ...rest) => (
  ...
  >
    ...
    <g data-name='Layer 2'>
      <g data-name='Layer 1'>
        <g data-name='Coffee Icon'>
          <path
            data-name='Coffee Cup'
            d='M6.178 17.986a6.233 6.233 0 0 1 6.196-6.907h50.089a6.233 6.233 0 0 1 6.196 6.907l-7.55 69.38a6.233 6.233 0 0 1-6.197 5.559H19.925a6.233 6.233 0 0 1-6.196-5.56Z'
            style={{
              fill: '#7b7b7b',
            }}
          />
          <path
            d='M69.346 6.984h-1.621V5.491A5.491 5.491 0 0 0 62.234 0h-49.48a5.491 5.491 0 0 0-5.492 5.49v1.494H5.491A5.491 5.491 0 0 0 0 12.475v2.988a5.491 5.491 0 0 0 5.491 5.491h63.855a5.49 5.49 0 0 0 5.491-5.49v-2.989a5.49 5.49 0 0 0-5.49-5.491Z'
            style={{
              fill: '#98c7eb',
            }}
          />
          <g data-name='Cup Sleeve'>
            <path
              data-name='Cup Sleeve'
              d='M3.577 43.06a5.491 5.491 0 0 1 5.45-6.164h56.93a5.49 5.49 0 0 1 5.45 6.165l-3.088 24.984a5.491 5.491 0 0 1-5.45 4.817H12.115a5.491 5.491 0 0 1-5.45-4.817Z'
              style={{
                fill: '#edaea3',
              }}
            />
            <path
              d='m37.532 63.532-1.298-1.29c-4.82-4.24-7.972-7.096-7.972-10.598a5.012 5.012 0 0 1 5.098-5.069 5.584 5.584 0 0 1 4.172 1.936 5.584 5.584 0 0 1 4.171-1.936 5.012 5.012 0 0 1 5.098 5.069c0 3.502-3.151 6.359-7.972 10.598Z'
              style={{
                fill: '#ff7878',
              }}
            />
...
export const BuyCoffeeIcon = (className, ...rest) => (
  <script
